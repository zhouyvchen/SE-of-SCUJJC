...
//    }
	...
	(function() {
		...
		var iframeUrlMap = {
			...
			'insertimage' : '~/dialogs/image/imageNew.html?v=2023-1007-1120' + '#'
			...
			'attachment_new' : '~/dialogs/attachment_new/attachment.html?v=2023-1007-2033' + '#'
					+ window.UEDITOR_CONFIG.DIYDOMAIN,
           ...
           'drawingboard' : '~/dialogs/drawingboard/index.html?v=2023-0718-1700' + '#'
			...
			'audio' : '~/dialogs/audio/attachmentNew.html?v=2023-1007-1120' + '#' + window.UEDITOR_CONFIG.DIYDOMAIN
		};
